...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo plugins_url(); ?>/project-panorama/assets/css/psp-frontend.css">
		
		<script type="text/javascript" src="<?php echo plugins_url(); ?>/project-panorama/assets/js/jquery.js"></script>
		<script type="text/javascript" src="<?php echo plugins_url(); ?>/project-panorama/assets/js/snap.svg-min.js"></script>
		<script type="text/javascript" src="<?php echo plugins_url(); ?>/project-panorama/assets/js/pizza.js"></script>
		<script type="text/javascript" src="<?php echo plugins_url(); ?>/project-panorama/assets/js/jquery.smooth-scroll.min.js"></script>
		<script type="text/javascript" src="<?php echo plugins_url(); ?>/project-panorama/assets/js/psp-frontend-behavior.js"></script>
	...
	<body class="psp-standalone-page">
		...
		<div id="psp-project">
			<?php while(have_posts()): the_post(); ?>
                ...
                <?php do_action('psp_between_progress-phases'); ?>

                <div id="psp-phases" class="wrapper">
				<?php 
				
				do_action('psp_before_phases');
					echo psp_phases($post->ID); 
				do_action('psp_after_phases');
