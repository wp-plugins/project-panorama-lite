<?php
    ...
    class psp_project_list_widget extends WP_Widget {
        ...
        function psp_project_list_widget() {

            //Constructor
            $widget_ops = array( 'classname' => 'psp_project_list_widget', 'description' => 'List of Panorama Projects' );
            $this->WP_Widget( 'psp_project_list_widget', 'Panorama Project List', $widget_ops);
